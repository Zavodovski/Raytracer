...
hittable_list random_scene()
{
    ...
    world = static_cast<hittable_list>(std::make_shared<bvh_node>(world, 0, 1));
...
hittable_list earth()
{
    auto earth_texture = std::make_shared<image_texture>("../images/earthmap2.jpg");
...
hittable_list final_scene()
{
    ...
    //for(auto& box : boxes1.objects) objects.add(box);
    objects.add(std::make_shared<bvh_node>(boxes1, 0, 1));

    //objects = static_cast<hittable_list>(std::make_shared<bvh_node>(boxes1, 0, 1));
    ...
    auto emat = std::make_shared<lambertian>(std::make_shared<image_texture>("../images/earthmap2.jpg"));
    ...
    objects.add(std::make_shared<translate>(
                ...
                std::make_shared<bvh_node>(boxes2, 0.0, 1.0), 15), vec3(-100, 270, 395)));
